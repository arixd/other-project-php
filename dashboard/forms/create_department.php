	...
	<div class="col-md-12">
		<div class="grid no-border">
			<div class="grid-header">
				...
				<span class="grid-title">Form New Department</span>
				...
				<form role="form" class="form-horizontal" enctype="multipart/form-data" method="post">
					...
					<div class="form-group">
						...
						<div class="col-md-4 btn-group">
							<button type="submit" class="btn btn-primary" name="create-department" style="margin-right:5px;"><span class="fa fa-plus"></span> Create</button>
							<button type="reset" class="btn btn-default" style="margin-right:5px;"><span class="fa fa-eraser"></span> Cancel</button>
							<a href="?data=department" class="btn btn-info" style="margin-right:5px;">
							<span class="fa fa-reply"></span> Back</a>
						</div>
					</div>
				</form>
			</div>
