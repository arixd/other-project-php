	...
	<div class="col-md-12">
		<div class="grid no-border">
			<div class="grid-header">
				...
				<span class="grid-title">Isi Tukar Jaga</span>
			...
			<div class="grid-body">
				...
				<form role="form" class="form-horizontal" enctype="multipart/form-data" method="post">
					...
					<label class="col-sm-2 control-label">Dari Shift</label>
							...
							<div class="col-md-4">	
							<?php
								$sql_radio5 = mysql_query("SELECT * FROM tabel_shift");
								while ($r_radio5=mysql_fetch_array($sql_radio5)){
									echo "<input type=radio name='id_shift_mengajukan' value='$r_radio5[id_shift]'>&nbsp; $r_radio5[nama_shift] &nbsp;&nbsp;
									";
								}
			...
			?>
				<div class="form-group">
					<h4 class="col-sm-11 control-label" style = "left : 10px;  border-left:10px solid red; height:30px;">
						<span style='margin-top:10px;'>Karyawan Pengganti Tukar Jaga</span></h4>
				</div>
					...
					<label class="col-sm-2 control-label">ke shift</label>
							...
							<?php 
								$sql_radio6 = mysql_query("SELECT * FROM tabel_shift");
								while ($r_radio6=mysql_fetch_array($sql_radio6)){
									echo "<input type=radio name='id_shift_menggantikan' value='$r_radio6[id_shift]'>&nbsp; $r_radio6[nama_shift] &nbsp;&nbsp;";
								}
							?>
					...
					<td>&nbsp;</td>
							...
							<button type="submit" class="btn btn-primary" name="create-request-tkjg-karyawan"><span class="fa fa-plus"></span> Submit</button>
