	...
	<div class="col-md-12">
		<div class="grid">
			<div class="grid-header">
				...
				<span class="grid-title">Profile</span>
				...
				<form role="form" class="form-horizontal" enctype="multipart/form-data" method="post">
					...
					<div class="form-group">
						...
						<div class="col-md-4 btn-group">
							<button type="submit" class="btn btn-primary" name="pass-update" style="margin-right:5px;"><span class="fa fa-save"></span> Update</button>
