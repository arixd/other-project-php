...
$site_url = "http://".$_SERVER['SERVER_NAME'].dirname($_SERVER["REQUEST_URI"]."?")."/";
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<meta name="author" content="Sonaji Yusup">
				...
				<ul class="nav navbar-nav">					
					<li class="dropdown profile-menu">
						...
						<ul class="dropdown-menu box profile">
							...
							<li class="border-top">
								<a href="?profile=<?php echo $_SESSION['user_id']; ?>"><i class="fa fa-user"></i><?php echo $_SESSION['fullname']; ?></a>
							</li>
							<li>
