...
while ($data=mysql_fetch_array($result)) {
	array_unshift($tahun, 'A. R');
	array_unshift($kelas_satu, $data['AR_tukarjaga']);
	array_unshift($kelas_dua, $data['AR_tukaroff']);
	array_unshift($kelas_tiga, $data['AR_ijinpribadi']);
	array_unshift($kelas_empat, $data['AR_sisacuti']);
