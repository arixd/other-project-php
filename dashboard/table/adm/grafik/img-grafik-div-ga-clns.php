...
while ($data=mysql_fetch_array($result)) {
	array_unshift($tahun, 'Cleaning Service ');
	array_unshift($kelas_satu, $data['CleaningService_tukarjaga']);
	array_unshift($kelas_dua, $data['CleaningService_tukaroff']);
	array_unshift($kelas_tiga, $data['CleaningService_ijinpribadi']);
	array_unshift($kelas_empat, $data['CleaningService_sisacuti']);
