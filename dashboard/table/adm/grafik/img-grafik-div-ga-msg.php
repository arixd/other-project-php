...
while ($data=mysql_fetch_array($result)) {
	array_unshift($tahun, 'Messangger ');
	array_unshift($kelas_satu, $data['Messanger_tukarjaga']);
	array_unshift($kelas_dua, $data['Messanger_tukaroff']);
	array_unshift($kelas_tiga, $data['Messanger_ijinpribadi']);
	array_unshift($kelas_empat, $data['Messanger_sisacuti']);
