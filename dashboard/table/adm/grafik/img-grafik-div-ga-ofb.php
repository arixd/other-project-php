...
while ($data=mysql_fetch_array($result)) {
	array_unshift($tahun, 'Ofice Boy ');
	array_unshift($kelas_satu, $data['OfficeBoy_tukarjaga']);
	array_unshift($kelas_dua, $data['OfficeBoy_tukaroff']);
	array_unshift($kelas_tiga, $data['OfficeBoy_ijinpribadi']);
	array_unshift($kelas_empat, $data['OfficeBoy_sisacuti']);
