...
while ($data=mysql_fetch_array($result)) {
	array_unshift($tahun, 'Parkir ');
	array_unshift($kelas_satu, $data['parkir_tukarjaga']);
	array_unshift($kelas_dua, $data['parkir_tukaroff']);
	array_unshift($kelas_tiga, $data['parkir_ijinpribadi']);
	array_unshift($kelas_empat, $data['parkir_sisacuti']);
