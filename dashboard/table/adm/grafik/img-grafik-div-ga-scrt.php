...
while ($data=mysql_fetch_array($result)) {
	array_unshift($tahun, 'Security ');
	array_unshift($kelas_satu, $data['SECURITY_tukarjaga']);
	array_unshift($kelas_dua, $data['SECURITY_tukaroff']);
	array_unshift($kelas_tiga, $data['SECURITY_ijinpribadi']);
	array_unshift($kelas_empat, $data['SECURITY_sisacuti']);
