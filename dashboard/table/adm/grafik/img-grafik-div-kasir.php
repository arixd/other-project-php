...
while ($data=mysql_fetch_array($result)) {
	array_unshift($tahun, 'Kasir');
	array_unshift($kelas_satu, $data['Kasir_tukarjaga']);
	array_unshift($kelas_dua, $data['Kasir_tukaroff']);
	array_unshift($kelas_tiga, $data['Kasir_ijinpribadi']);
	array_unshift($kelas_empat, $data['Kasir_sisacuti']);
