							...
							<div class="form-group">
								...
								<tr>
									...
									<td>
										<?php 
											if($data['tandai']===NULL){
												echo "<span class='btn btn-danger'> <b>Belum Dibaca</b></span>";
											}else{
												echo"Sudah dibaca";
											}
										?>
									...
									<td>
											...
											$reschedule_id=$data['id_spdl'];


											echo '
											<a href="?reschedule_id_baca='.$reschedule_id.'&changestat=Read" class="btn btn-success"><span class="fa fa-times"></span>Flag</a>
											';
