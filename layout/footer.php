				...
				<div class="row">
					<div class="col-md-4">
						...
						<table>
							...
							<tr>
								...
								<td width="10%">:</td>
								<td width="50%">info@astonbogor.com</td>
							</tr>
							<tr>
								<td width="40%">HP</td>
								<td width="10%">:</td>
								<td width="50%">+62-251-8200-300</td>
							</tr>
							<tr>
								<td width="40%">Alamat</td>
								<td width="10%">:</td>
								<td width="50%">The Jungle-Bogor Nirwana Residence Jl.Dreded Pahlawan Bogor 16132 West Java</td>
							</tr>
						</table>
					</div>
					<div class="col-md-2">
					...
					<?php 
						if (isset($_SESSION['access'])) {
							if ($_SESSION['access'] == 'admin' OR 'employee' OR 'director' OR 'head_department') {
					?>
						<div class="col-md-6">
							<h3>My Profile</h3>
							<ul class="fa-ul">
								<li><i class="fa fa-li fa-user"></i> <?php echo $_SESSION['fullname']; ?></li>

							</ul>
						</div>
						<div class="col-md-6">
							<img src="dashboard/<?php echo $_SESSION['photo']; ?>" class="img-circle" style="margin-top:20px; width:50%;">
						</div>
					<?php
							}
						}else {
